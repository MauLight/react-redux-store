                            ...
                            <header className='w-[1440px] text-[#ffffff] flex flex-col gap-y-2 tracking-tight uppercase'>
                                <div className='flex'>
                                    <div className='flex flex-col items-end gap-y-5'>
                                        ...
                                        {
                                            isEditing ? (
                                                <form className='text-[#10100e]' onSubmit={handleSubmit(handleOpenConfirmation)}>
                                                    ...
                                                    <input {...register('email')} type='text' className={`mt-2 w-full h-9 bg-gray-50 rounded-[3px] border border-gray-300 ring-0 focus:ring-0 focus:outline-none px-2 placeholder-sym_gray-500 ${errors.email !== undefined ? 'ring-1 ring-red-500' : ''}`} placeholder='Email' />
                                                    <input {...register('address')} type='text' className={`mt-2 w-full h-9 bg-gray-50 rounded-[3px] border border-gray-300 ring-0 focus:ring-0 focus:outline-none px-2 placeholder-sym_gray-500 ${errors.address !== undefined ? 'ring-1 ring-red-500' : ''}`} placeholder='Address' />
                                                    <input {...register('phone')} type='text' className={`mt-2 w-full h-9 bg-gray-50 rounded-[3px] border border-gray-300 ring-0 focus:ring-0 focus:outline-none px-2 placeholder-sym_gray-500 ${errors.phone !== undefined ? 'ring-1 ring-red-500' : ''}`} placeholder='Phone' />
