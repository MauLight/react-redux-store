...
function UpdateProductForm({ product }: IndividualProductFormProps): ReactNode {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className='w-full col-span-1 flex gap-x-5 px-4 md:px-10 py-10 bg-[#ffffff] rounded-[8px]'>
